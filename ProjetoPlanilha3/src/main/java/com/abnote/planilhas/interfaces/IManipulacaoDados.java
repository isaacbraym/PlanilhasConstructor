...
public interface IManipulacaoDados {
	 ...
	 *
	 * @param dados       Os dados a serem inseridos (pode ser String, List ou
	 *                    File).
	...
	/**
	 * Converte os valores da coluna indicada para numérico.
	 *
	...
	/**
	 * Converte os valores da coluna para o formato contábil.
	 *
	 * @param posicaoInicial A posição inicial da coluna (ex.: "J3").
	 * @return A instância atual para encadeamento.
	 */
	IManipulacaoDados converterEmContabil(String posicaoInicial);
	...
	/**
	 * Retorna uma instância para aplicar estilos na célula atual.
	 *
	 * @return A instância de EstiloCelula.
	 */
